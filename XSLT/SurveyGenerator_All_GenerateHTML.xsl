...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Conservation Survey Report - All Clowes Objects"/></title>
        <style media="all">
...
<xsl:for-each select="r">
    <xsl:variable name="creator" select="m/mv[@c='CRECREATORREF_TAB']"/>
    <xsl:variable name="accessionNo" select="m/mv[@c='TITACCESSIONNO']"/>
    
    <body>
        <div class="ima-collection-survey-report" xmlns="http://www.w3.org/1999/xhtml" style="page-break-after: always">
            <table class="header">
                <tbody>
                    <tr>
                        <td class="logo">
